    ...
    create table ordine (
        ...
        prezzo_totale numeric(38,2) not null,
        data_creazione timestamp(6) not null,
        indirizzo_destinazione varchar(255) not null,
        status varchar(255) not null check ((status in ('ORDINE_ACCETTATO','IN_PREPARAZIONE','IN_TRANSITO','COMPLETATO'))),
        primary key (id)
    );
...
=======
        ...
        quantita integer,
        summary varchar(255),
>>>>>>> 742a05b89eb0694b68f888a338c9c5efdc73caad
        primary key (id)
    );
